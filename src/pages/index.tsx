...
const Home: NextPage = () => {
  return (
    <>
      ...
      <div className="w-screen min-h-screen bg-black select-none flex flex-col">
        <div className="md:mt-[11rem] lg:mt-[11rem] mt-[5rem] px-[5rem] flex lg:flex-row items-center flex-col mb-[3rem]">
          <div className="flex flex-col h-[20rem] md:h-[15rem] lg:h-[20rem]">
            ...
            <Link href={"/home"}>
              <h3 className="text-blue-500 text-2xl cursor-pointer hover:text-blue-700 w-[201px] mt-2 md:mt-12 lg:mt-12 animate-bounce">{`<Enter> to start`}</h3>
            </Link>
          </div>
          <div className="flex">
        ...
        <div className="mt-auto mb-[2rem] px-[5rem]">
          ...
          <div className="text-white text-xs text-center mt-6 md:text-sm lg:text-sm">
            ...
            <h2>Copyright © 2023 BiotechAlfa.com. All Rights Reserved.</h2>
          </div>3
        </div>
      </div>
    </>
